...
import listings from "../data/workData.json";
...
const WorkListings = () => {
  return (
    <section
      id="work"
      className="c-work w-full py-16 pt-20 sm:py-24 sm:pt-20 bg-zinc-50 "
      data-section="work"
    >
      <div className="c-work__container mx-auto max-w-7xl px-6">
        ...
        <div className="c-work__content js-work mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {listings.map((listing) => (
            <WorkListing key={listing.id} listing={listing} />
          ))}
        </div>
      </div>
    </section>
